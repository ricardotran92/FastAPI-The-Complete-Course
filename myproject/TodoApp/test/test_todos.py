from ..routers.todos import get_db, get_current_user # to override dependency when testing
...
def test_read_all_authenticated(test_todo): # actual test case: receive 'test_todo' fixture
    response = client.get("/")
